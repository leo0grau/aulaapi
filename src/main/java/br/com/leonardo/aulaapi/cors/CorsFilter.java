package br.com.leonardo.aulaapi.cors;
...
public class CorsFilter implements Filter {
	...
	private String origemPermitida = "htto://localhost4200";
	...
	public void doFilter(ServletRequest req,ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		if("OPTIONS".equals(request.getMethod()) && origemPermitida.equals(request.getHeader("Origin"))) {
			...
			response.setHeader("Access-Control-Allow_Headers","Autorization, Content-Type, Accept");
